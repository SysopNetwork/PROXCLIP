...
| Version | Date | Notes |
|---------|------|-------|
| 1.0.7 | 2026-06-11 | Add `__declspec(dllexport)` to internal hook functions — ensures MBBS can resolve them via `GetProcAddress` at runtime regardless of `.DEF` file export alias handling |
